...
def visulize_mapping(b_points, size, filename):
    print(os.path.join('./data/training/BAD_resize_100_100', filename))
    img = cv2.imread(
        os.path.join('./data/training/BAD_resize_100_100', filename))  # change the path when using other dataset.
